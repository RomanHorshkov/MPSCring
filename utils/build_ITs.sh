...
# Build mpscring object (integration tests link against this object).
gcc -std=c11 -O2 -g -DMPSC_REQUIRE_ALWAYS_LOCK_FREE -Iapp -c app/mpscring.c -o "${BUILD_DIR}/mpscring.o"
