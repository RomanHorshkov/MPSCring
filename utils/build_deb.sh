#!/usr/bin/env bash
# =============================================================================
# build_deb.sh — package the release-profile libmpscring artifacts into debs
#
...
#
#   libmpscring_<ver>_<arch>.deb      runtime: libmpscring.so.<ver> + soname symlink
#   libmpscring-dev_<ver>_<arch>.deb  development: mpscring.h, libmpscring.a,
#                                     libmpscring.so linker symlink; depends on
#                                     the exact-version runtime package
#
# plus a SHA256SUMS manifest covering both, in build/debs/.
#
# Both packages conflict with and replace the former single package "mpscring",
...
LIB="mpscring"
PKG_RUNTIME="libmpscring"
PKG_DEV="libmpscring-dev"
PKG_OLD="mpscring"
